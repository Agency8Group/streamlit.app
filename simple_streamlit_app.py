...
def get_chat_response(user_input):
    ...
    try:
        # 시스템 메시지와 대화 기록 준비
        messages = [
            {"role": "system", "content": "You are an advanced AI neural interface with email transmission capabilities. When users request email sending with phrases like '메일 보내줘' or '메일 보내줄래', you should generate appropriate email content based on the conversation context. Create professional, meaningful email content that reflects your AI thoughts and analysis, not just repeat what the user said. Use technical language with cyberpunk/hacker aesthetic. You have access to Gmail SMTP for secure email transmission."}
        ]
            ...
            with st.chat_message("assistant"):
                with st.spinner("⚡ [NEURAL PROCESSING] Analyzing input..."):
                    ...
                    if email_request:
                        ...
                        # AI가 생성한 응답을 이메일 내용으로 사용
                        email_content = f"""NEURAL INTERFACE v2.1.3 - AI Generated Transmission

Timestamp: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}
Source: Advanced AI Neural Network

{response}

---
This message was generated by NEURAL INTERFACE v2.1.3
Advanced AI Communication Protocol
"""
